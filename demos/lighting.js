...
let fgColor = vec4.fromValues(1.0, 0.9, 0.5, 3.0);

app.enable(PicoGL.DEPTH_TEST)
   .enable(PicoGL.CULL_FACE)
   .clearColor(bgColor[3], bgColor[4], bgColor[2], bgColor[3]);
...
let lightPosition = vec3.fromValues(1, 4, 2.5);
...
function drawObjects(dc) {
    ...
    // Middle object
    quat.fromEuler(rotation, time * 48.24, time * 23, 0);
